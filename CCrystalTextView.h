...
private:
  ...
  BOOL m_bBreakpointExist;     // More bookmarks
...
public:
  ...
  public:
    ...
    //	Text search helpers
    BOOL DivulgeText(LPCTSTR pszText, const CPoint &ptStartPos, DWORD dwFlags, BOOL bWrapSearch, CPoint *pptFoundPos);
  ...
  public:
    CCrystalTextView();
    ~CCrystalTextView();
    void OnToggleSyntaxError(int line);
    void OnClearAllSyntaxErrors();
  protected:
  ...
  protected:
    ...
    afx_msg void OnToggleBreakpoint();	// More Breakpoints
    afx_msg void OnClearAllBreakpoints();
    afx_msg void OnNextBreakpoint();
    afx_msg void OnPrevBreakpoint();
    afx_msg void OnUpdateClearAllBreakpoints(CCmdUI* pCmdUI);
    afx_msg void OnUpdateNextBreakpoint(CCmdUI* pCmdUI);
    afx_msg void OnUpdatePrevBreakpoint(CCmdUI* pCmdUI);
