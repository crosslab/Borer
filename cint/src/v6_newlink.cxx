...
void G__cppif_genconstructor(FILE *fp, FILE * /* hfp */, int tagnum, int ifn, G__ifunc_table *ifunc)
{
  ...
  bool has_a_new = ((G__struct.funcs[tagnum] & (G__HAS_OPERATORNEW1ARG | G__HAS_OPERATORNEW2ARG))!=0)?true:false;
  bool has_a_new1arg = ((G__struct.funcs[tagnum] & G__HAS_OPERATORNEW1ARG)!=0)?true:false;
  bool has_a_new2arg = ((G__struct.funcs[tagnum] & G__HAS_OPERATORNEW2ARG)!=0)?true:false;
...
#define G__OLDIMPLEMENtATION1972
  ...
  *********************************************************************/
  ...
  if ((0 >= isdestructor) && (G__struct.type[tagnum] != 'n')) {
    ...
    bool has_a_delete = ((G__struct.funcs[tagnum] & G__HAS_OPERATORDELETE)!=0)?true:false;
...
* Used in G__cpplink.C
**************************************************************************/
int G__memvar_setup(void *p,int type
                    ,int reftype
