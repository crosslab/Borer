...
# Compile and Install Cint core
 ...
 Visual C++ 7.0
   ...
   Go to c:\cint\platform\visualCpp8 directory and run setup.bat. This script
   updates c:\autoexec.bat. Reboot system after installation. 

        c:\cint> cd c:\cint\platform\visualCpp8

   Depending on operation system and compiler version, run following
   setup script.

        c:\cint\platform\visualCpp8> setup.bat
