echo off
REM ###########################################################################
REM # platform\visualCpp8\setup.bat
REM #
...
copy %CINTSYSDIR%\platform\visualCpp8\MAKEINFO %CINTSYSDIR%\MAKEINFO
copy %CINTSYSDIR%\platform\visualCpp8\update.bat %CINTSYSDIR%\update.bat
copy %CINTSYSDIR%\platform\visualCpp8\updatedb.bat %CINTSYSDIR%\updatedb.bat

REM # COPY PROJECT FILES
mkdir %CINTSYSDIR%\cint
copy %CINTSYSDIR%\platform\visualCpp8\cint.mak %CINTSYSDIR%\cint\cint.mak
copy %CINTSYSDIR%\platform\visualCpp8\cint.dsw %CINTSYSDIR%\cint\cint.dsw
copy %CINTSYSDIR%\platform\visualCpp8\cint.dsp %CINTSYSDIR%\cint\cint.dsp

mkdir %CINTSYSDIR%\src\libcint
copy %CINTSYSDIR%\platform\visualCpp8\src\libcint.mak %CINTSYSDIR%\src\libcint\libcint.mak
copy %CINTSYSDIR%\platform\visualCpp8\src\libcint.def %CINTSYSDIR%\src\libcint\libcint.def
copy %CINTSYSDIR%\platform\visualCpp8\src\libcint.dsw %CINTSYSDIR%\src\libcint\libcint.dsw
copy %CINTSYSDIR%\platform\visualCpp8\src\libcint.dsp %CINTSYSDIR%\src\libcint\libcint.dsp

mkdir %CINTSYSDIR%\include\mkincld
copy %CINTSYSDIR%\platform\visualCpp8\include\mkincld.mak %CINTSYSDIR%\include\mkincld\mkincld.mak
copy %CINTSYSDIR%\platform\visualCpp8\include\mkincld.mdp %CINTSYSDIR%\include\mkincld\mkincld.mdp
...
REM # BUILD MAKECINT
cd %CINTSYSDIR%\platform\visualCpp8\tool\makecint
...
move %CINTSYSDIR%\platform\visualCpp8\tool\makecint\Release\makecint.exe %CINTSYSDIR%\makecint.exe

REM # BACK TO THE ORIGINAL DIRECTORY
cd %CINTSYSDIR%\platform\visualCpp8
...
echo Removing %CINTSYSDIR%\platform\visualCpp8\tool\makecint\Release
del %CINTSYSDIR%\platform\visualCpp8\tool\makecint\Release
rmdir %CINTSYSDIR%\platform\visualCpp8\tool\makecint\Release
