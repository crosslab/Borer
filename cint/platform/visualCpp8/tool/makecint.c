...
FILE *fp;
{
  ...
  if(G__CPPHDR) {
    fprintf(fp,"################################################################################\n");
    fprintf(fp,"$(CPPIFC) : $(CPPHEADER) $(CPPSTUB) %s\n",G__makefile);
...
G__outputmakefile() {
 ...
 fprintf(fp,"\n");
 fprintf(fp,"# ADD BASE CPP /nologo /W3 /EHsc /O2 /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"WIN32\" /D \"NDEBUG\" /D \"_CONSOLE\" /c\n");
 fprintf(fp,"# ADD CPP /nologo /W3 /EHsc /O2 /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"NDEBUG\" /D \"WIN32\" /D \"_CONSOLE\" /D \"G__VISUAL\" /D \"G__WIN32\" /D \"G__SHAREDLIB\" /c\n");
 fprintf(fp,"CPP_PROJ=/nologo /ML /W3 /EHsc /O2 /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"NDEBUG\" /D\\\n");
 ...
 fprintf(fp,"    if not exist \"$(OUTDIR)/$(NULL)\" mkdir \"$(OUTDIR)\"\n");
 fprintf(fp,"\n");
 fprintf(fp,"# ADD BASE CPP /nologo /W3 /Gm /EHsc /Zi /Od /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"WIN32\" /D \"_DEBUG\" /D \"_CONSOLE\" /c\n");
 fprintf(fp,"# ADD CPP /nologo /W3 /Gm /EHsc /Zi /Od /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"_DEBUG\" /D \"WIN32\" /D \"_CONSOLE\" /D \"G__VISUAL\" /D \"G__WIN32\" /D \"G__SHAREDLIB\" /c\n");
 fprintf(fp,"CPP_PROJ=/nologo /MLd /W3 /Gm /EHsc /Zi /Od /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D\\\n");
 fprintf(fp," \"_DEBUG\" /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"WIN32\" /D \"_CONSOLE\" /D \"G__VISUAL\" /D \"G__WIN32\" /D\\\n");
...
G__outputmakefiledll() {
 ...
 fprintf(fp,"    if not exist \"$(OUTDIR)/$(NULL)\" mkdir \"$(OUTDIR)\"\n");
 fprintf(fp,"\n");
 fprintf(fp,"# ADD BASE CPP /nologo /MT /W3 /EHsc /O2 /D \"WIN32\" /D \"NDEBUG\" /D \"_WINDOWS\" /c\n");
 fprintf(fp,"# ADD CPP /nologo /MT /W3 /EHsc /O2 /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D \"NDEBUG\" /D \"WIN32\" /D \"_WINDOWS\" /D \"G__VISUAL\" /D \"G__WIN32\" /D \"G__SHAREDLIB\" /c\n");
 fprintf(fp,"CPP_PROJ=/nologo /MT /W3 /EHsc /O2 /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D \"NDEBUG\" /D\\\n");
 fprintf(fp," \"WIN32\" /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"_WINDOWS\" /D \"G__VISUAL\" /D \"G__WIN32\" /D \"G__SHAREDLIB\"\\\n");
 fprintf(fp," /Fp\"$(INTDIR)/%s.pch\" /Fo\"$(INTDIR)/\" /c $(IPATH) $(MACRO)\n",G__DLLID);
 fprintf(fp,"CPP_OBJS=.\\Release/\n");
 fprintf(fp,"CPP_SBRS=\n");
 ...
 fprintf(fp,"    if not exist \"$(OUTDIR)/$(NULL)\" mkdir \"$(OUTDIR)\"\n");
 fprintf(fp,"\n");
 fprintf(fp,"# ADD BASE CPP /nologo /MTd /W3 /Gm /EHsc /Zi /Od /D \"WIN32\" /D \"_DEBUG\" /D \"_WINDOWS\" /c\n");
 fprintf(fp,"# ADD CPP /nologo /MTd /W3 /Gm /EHsc /Zi /Od /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D \"_DEBUG\" /D \"WIN32\" /D \"_WINDOWS\" /D \"G__VISUAL\" /D \"G__WIN32\" /D \"G__SHAREDLIB\" /c\n");
 fprintf(fp,"CPP_PROJ=/nologo /MTd /W3 /Gm /EHsc /Zi /Od /I \"$(CINTSYSDIR)\" /I \"$(CINTSYSDIR)/src\" /D\\\n");
 fprintf(fp," \"_DEBUG\" /D \"WIN32\" /D \"_WINDOWS\" /D \"G__VISUAL\" /D _CRT_SECURE_NO_DEPRECATE /D _SECURE_SCL=0 /D \"G__WIN32\" /D\\\n");
 fprintf(fp," \"G__SHAREDLIB\" /Fp\"$(INTDIR)/%s.pch\" /Fo\"$(INTDIR)/\" /Fd\"$(INTDIR)/\"\\\n",G__DLLID);
 fprintf(fp," /c $(IPATH) $(MACRO)\n");
 fprintf(fp,"CPP_OBJS=.\\Debug/\n");
 fprintf(fp,"CPP_SBRS=\n");
