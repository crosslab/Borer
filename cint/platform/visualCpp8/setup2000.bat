echo off
REM ###########################################################################
REM # platform\visualCpp8\setup2000.bat
REM #
...
IF not defined CINTSYSDIR SET CINTSYSDIR=C:\CINT
...
copy %CINTSYSDIR%\platform\visualCpp8\cint.vcproj %CINTSYSDIR%\cint\cint.vcproj
copy %CINTSYSDIR%\platform\visualCpp8\cint.sln %CINTSYSDIR%\cint\cint.sln
...
copy %CINTSYSDIR%\platform\visualCpp8\src\libcint.vcproj %CINTSYSDIR%\src\libcint\libcint.vcproj
...
echo # set CINTSYSDIR=$CINTSYSDIR
