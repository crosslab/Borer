...
extern G__EXPORT int G__first_exam G__P((G__CONST char *exam));
...
static int G__first_exam G__P((G__CONST char *exam));
...
,int tagnum,int typenum,int reftype,int para_nu,int ansi,int access,int isconst,G__CONST char *paras,G__CONST char *comment)) )  a26;
  ...
  G__first_exam = (int (*) G__P((G__CONST char *exam)) ) a140;
}
