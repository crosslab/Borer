...
public:
  ...
  void EncryptBuf(char const* in, char* result, size_t n, int iMode=ECB);
  
  void DecryptBuf(char const* in, char* result, size_t n, int iMode=ECB);
  
  //Encryption for a File
  bool TousleFile(CString rostrFileIn, CString rostrFileOut);
  //Decryption for a File
  bool RenovateFile(CString rostrFileIn, CString rostrFileOut);
